...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  return (
    <>
      {/* 🔰 FULL-SCREEN BLINKIT BACKGROUND (no cropping) */}
      {/* Make sure /frontend/public/blinkit-bg.jpg exists */}
      <div
        className="
          fixed inset-0 -z-10
          bg-[#FFE500]
          bg-[url('/blinkit-bg.jpg')]
          bg-no-repeat
          bg-contain
          bg-center
        "
          ...
          <div className={cn(classNames.grid)}>
            ...
            >
              <AnimatePresence mode="popLayout">
                {!isAvatar && (
                  // Audio Agent (now transparent, no big black square)
                  <MotionContainer
                    key="agent"
                    layoutId="agent"
                    initial={{
